...
<div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
    <div
      className="rounded-2xl border border-rose-600 p-6 shadow-sm ring-1 ring-rose-600 sm:order-last sm:px-8 lg:p-12"
    >
      ...
      <a
        href="#"
        className="mt-8 block rounded-full border border-rose-600 bg-rose-600 px-12 py-3 text-center text-sm font-medium text-white hover:bg-rose-700 hover:ring-1 hover:ring-rose-700 focus:outline-none focus:ring active:text-rose-500"
      >
        Get Started
      </a>
    </div>
